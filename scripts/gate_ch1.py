...
SUBJECT_MAP = [
    ...
    (r'famously',                              r'tiny_arms_macro|ch1_arms'),
    (r'push you back up',                      r'trip_stumble|ch1_down'),
    (r'falling down is the same as dying',     r'i_uhoh'),
    (r'wet, flat concrete',                    r'wet_asphalt'),
    (r'furnace',                               r'ch1_furnace'),
    (r'food than this entire street',          r'food_cart|ch1_cart'),
    (r'survive here',                          r'taxi_hunt'),
    (r'to hunt here',                          r'glass_reflection|ch1_glass|taxi_hunt'),
    (r'glass, steel',                          r'glass_tower'),
    (r'four million strangers',                r'pov_crowd_up|ch1_crowdup'),
