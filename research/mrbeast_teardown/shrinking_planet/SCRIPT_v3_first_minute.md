...
**ORB** (mouth:OFF, emotion: announcer): These two were a **band**. Four years, one bus, **one hit**.
**ORB** (mouth:OFF, emotion: dry): She went **solo**. He's still **mad**.
**ORB** (mouth:OFF, emotion: big): Survive **thirty days** here, **together**, and that **crate** is yours.
