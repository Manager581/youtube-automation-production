...
- ✅ Zone 7 Lunch S59–S60 + 2 owner-added shots (2026-07-08, owner approved) — SAME thread as Zone 6. S59 walk-to-food, S60 BBQ table (MIDROLL SLOT). Owner added **S59b** (market row: Dino Dogs hot-dog stand + Dino Smokehouse) and **S59c** (in-park McDonald's, golden arches on themed timber building) — both inserted into STORYBOARD.tsv after S59 with PROVISIONAL timecodes (realign needed before render; Lunch grew 2→4 shots so all downstream timecodes shift). S59c regenerated once (v1 rendered a stranger, not GF — fixed by inlining the full GF description). Trademark note in S59c Edit col: keep McDonald's a brief incidental beat in the monetized cut.
...
- ⬜ REMAINING STILLS (no more zones): S13b/S14a/S14b dialogue-split rows from the i2v pilot (one small ChatGPT session, S13.png ref) + nothing else GEN. All TRIMs (cold-open S03–S12, S65b/S66b/S67b/S67c, S74b/S77b/S77c/S77d) are cut from CLIPS, so they wait on i2v zones 8–10. Lunch-zone timecode realign (S59b/S59c inserts shifted downstream rows) still owed before render.
...
- I2V PROGRESS: ✅ Z1 pilot S13–S16 (owner approved 2026-07-08, status=clip) → ✅ Z2 S17–S23 (owner approved 2026-07-08, status=clip; S13b/S14a/S14b stay todo — stills not generated yet) → 🟨 Z3 S24–S30 (clips in v2/clips/, whisper-verified, PENDING owner approval; S24 EXTEND-to-7s DROPPED — Grok Extend re-renders audio and lost GF/Luke lines 2-3 twice, kept the verified 6s base; ear-check S29 "Hatzegopteryx"; S26 v1 REJECTED — chick flew through the glass → owner rule "real physics" in memory `feedback_i2v_real_physics`, physics rider baked into S26 TSV prompt, regen passed 2fps frame check) → ⬜ Z4 S31–S42 → ⬜ Z5 S43–S50 → (zones 6–10 as their stills get approved) → ⬜ cold-open TRIMs + cards.
