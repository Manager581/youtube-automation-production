...
- ⬜ REMAINING STILLS (no more zones): S13b/S14a/S14b dialogue-split rows from the i2v pilot (one small ChatGPT session, S13.png ref) + nothing else GEN. All TRIMs (cold-open S03–S12, S65b/S66b/S67b/S67c, S74b/S77b/S77c/S77d) are cut from CLIPS, so they wait on i2v zones 8–10. Timecode realign DONE (see Zone 7 note below).
